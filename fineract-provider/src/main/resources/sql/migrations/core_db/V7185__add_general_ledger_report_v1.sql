...
-- under the License.
-- Created 06/06/2023 ,time 1451
-- Created By Sinatra Gunda @treyviis@gmail.com

INSERT INTO `stretchy_report` (`report_name`, `report_type`, `report_subtype`, `report_category`, `report_sql`, `description`, `core_report`, `use_report`) VALUES ('General Ledger Report V1', 'Pentaho', NULL, 'Accounting', NULL, NULL, 0, 1);

    

INSERT INTO `stretchy_report_parameter` (`report_id`, `parameter_id`, `report_parameter_name`) VALUES
 ((select sr.id from stretchy_report sr where sr.report_name='General Ledger Report V1'), 
