...
VALUES ('Loans Submission', 'Pentaho', NULL, 'Loan', NULL, 'New Loans Submitted Report', 0, 1);


INSERT INTO `stretchy_report_parameter` (`report_id`, `parameter_id`, `report_parameter_name`) VALUES
 ((select sr.id from stretchy_report sr where sr.report_name='Loans Submission'), 
