...
-- under the License.
-- Added 05/11/2022 at 0843

INSERT INTO `stretchy_report` (`report_name`, `report_type`, `report_subtype`, `report_category`, `report_sql`, `description`, `core_report`, `use_report`) VALUES ('Rx Deal', 'Pentaho', NULL, 'Loan', NULL, NULL, 1, 1);
