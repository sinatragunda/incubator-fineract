...
INSERT INTO `stretchy_report` VALUES (null ,'TotalInNPA', 'Table', '', 'Loan', 'SELECT SUM(ml.total_outstanding_derived) AS due FROM m_loan ml JOIN m_client mc ON mc.id = ml.client_id WHERE ml.is_npa = false AND mc.office_id = ${officeId}
