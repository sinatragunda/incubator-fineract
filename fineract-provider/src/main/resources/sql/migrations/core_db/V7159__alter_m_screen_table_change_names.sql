...
-- Created 12/04/2023 2115

DROP TABLE IF EXISTS `m_screen_object`;
...
CREATE TABLE `m_screen` (
	...
	`parent_screen_id` BIGINT(20) NOT NULL DEFAULT '0',
	PRIMARY KEY (`id`) USING BTREE
)
COMMENT='Screen main handler called from screen ui .Contains Screen Elements .'
