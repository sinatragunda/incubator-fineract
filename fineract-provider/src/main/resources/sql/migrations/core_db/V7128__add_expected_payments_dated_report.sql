...
VALUES ('Expected Payments Dated', 'Pentaho', NULL, 'Loan', NULL, 'Expected Payments Dated ,new report', 0, 1);


INSERT INTO `stretchy_report_parameter` (`report_id`, `parameter_id`, `report_parameter_name`) VALUES
 ((select sr.id from stretchy_report sr where sr.report_name='Expected Payments Dated'), 
