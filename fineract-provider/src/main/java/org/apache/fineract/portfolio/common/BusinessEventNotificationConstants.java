...
public class BusinessEventNotificationConstants {
    ...
    public static enum BUSINESS_EVENTS {
        ...
        // Added 19/09/2021
        DEPRECIATION_PRODUCT_CREATE("depreciation_product_create"),
        DEPRECIATION_PRODUCT_APPROVE("depreciation_product_approve"),
        DEPRECIATING_ASSET_CREATE("depreciating_asset_create"),
        DEPRECIATING_ASSET_APPROVE("depreciating_asset_approve");
    ...
    public static enum BUSINESS_ENTITY {
        ...
        SHARE_ACCOUNT("share_account"), SHARE_PRODUCT("share_product"), DEPOSIT_ACCOUNT("deposit_account"), LOAN_PRODUCT("loan_product") ,DEPRECIATION_PRODUCT("depreciation_product");
