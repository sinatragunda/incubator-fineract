...
@Service
@CommandType(entity = "RXDEAL", action = "CREATE")
public class CreateRxDealHandler implements NewCommandSourceHandler {

    private final RxDealWritePlatformService rxDealWritePlatformService ;

    @Autowired
    public CreateRxDealHandler(final RxDealWritePlatformService rxDealWritePlatformService) {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        return this.rxDealWritePlatformService.createRxDeal(command);
    }
}
