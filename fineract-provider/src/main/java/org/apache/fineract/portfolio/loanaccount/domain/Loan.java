...
public class Loan extends AbstractPersistableCustom<Long> {
    ...
    public Map<String, Object> loanApplicationModification(final JsonCommand command, final Set<LoanCharge> possiblyModifedLoanCharges,
        ...
        // added 02/07/2021
        final String autoSettlementAtDisbursementParameterName = "autoSettlementAtDisbursement";
        if (command.isChangeInBooleanParameterNamed(autoSettlementAtDisbursementParameterName, autoSettlementAtDisbursement())) {
