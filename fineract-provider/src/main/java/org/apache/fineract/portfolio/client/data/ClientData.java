...
final public class ClientData extends Record implements Comparable<ClientData> , EnumeratedData {
   ...
   // private Collection<LocalRefValueData> localRefValueDataCollection;
    ...
    public static ClientData importClientEntityInstance(Long legalFormId,Integer rowIndex,String fullname,Long officeId, Long clientTypeId,
            ...
            AddressData address,String locale,String dateFormat ,String emailAddress,Long savingsProductId ,Long shareProductId ,String tag){
        return  new ClientData(legalFormId,rowIndex,fullname, null, null, null, submittedOnDate,activationDate,active, externalId,
        		...
        		address,clientNonPersonDetails, locale,dateFormat,emailAddress ,savingsProductId ,shareProductId,null ,tag);
    }
    ...
    public static ClientData importClientPersonInstance(Long legalFormId,Integer rowIndex,String firstName,String lastName,String middleName,
            ...
            Long clientClassificationId, Boolean isStaff, AddressData address,String locale,String dateFormat ,String emailAddress ,Long savingsProductId ,Long shareProductId ,Boolean createSelfServiceUser ,String tag){
        ...
        return new ClientData(legalFormId,rowIndex, null, firstName,lastName,middleName,submittedOn,activationDate,active,externalId,
                officeId,staffId,mobileNo,dob,clientTypeId,genderId,clientClassificationId,isStaff,address, null, locale,dateFormat ,emailAddress ,savingsProductId ,shareProductId ,createSelfServiceUser ,tag);
    }
    ...
    private ClientData(Long legalFormId,Integer rowIndex, String fullname, String firstname,String lastname,String middlename,
            ...
            String locale,String dateFormat ,String emailAddress ,Long savingsProductId ,Long shareProductId ,Boolean createSelfServiceUser ,String tag) {
    ...
    public static ClientData template(final Long officeId, final LocalDate joinedDate, final Collection<OfficeData> officeOptions,
            ...
            final Boolean isAddressEnabled, final List<DatatableData> datatables,final LocalRefData localRefData) {
        ...
        return new ClientData(accountNo, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id, firstname,
                ...
                clientNonPersonDetails, clientLegalFormOptions,familyMemberOptions, legalForm,address, isAddressEnabled, datatables, isStaff ,shareProductId ,shareAccountId,createSelfServiceUser ,tag ,localRefData);
    ...
    public static ClientData templateOnTop(final ClientData clientData, final ClientData templateData) {
        ...
        return new ClientData(clientData.accountNo, clientData.status, clientData.subStatus, clientData.officeId, clientData.officeName,
                ...
                templateData.clientLegalFormOptions,templateData.familyMemberOptions, clientData.legalForm, clientData.address,clientData.isAddressEnabled, null, clientData.isStaff ,null ,clientData.shareAccountId ,clientData.createSelfServiceUser ,clientData.tag ,clientData.localRefData);
    ...
    public static ClientData templateWithSavingAccountOptions(final ClientData clientData,
        ...
        return new ClientData(clientData.accountNo, clientData.status, clientData.subStatus, clientData.officeId, clientData.officeName,
                ...
                clientData.clientLegalFormOptions,clientData.familyMemberOptions, clientData.legalForm,clientData.address, clientData.isAddressEnabled, null, clientData.isStaff ,null ,clientData.shareAccountId ,clientData.createSelfServiceUser, clientData.tag ,clientData.localRefData);
    ...
    public static ClientData setParentGroups(final ClientData clientData, final Collection<GroupGeneralData> parentGroups) {
        return new ClientData(clientData.accountNo, clientData.status, clientData.subStatus, clientData.officeId, clientData.officeName,
				...
				clientData.isAddressEnabled, null, clientData.isStaff,null ,clientData.shareAccountId ,clientData.createSelfServiceUser ,clientData.tag ,clientData.localRefData);
    ...
    public static ClientData clientIdentifier(final Long id, final String accountNo, final String firstname, final String middlename,
        ...
        return new ClientData(accountNo, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id, firstname,
                ...
                savingsProductId, savingsProductName, savingsAccountId, savingAccountOptions, clientType, clientClassification,
                clientTypeOptions, clientClassificationOptions, clientNonPersonConstitutionOptions, clientNonPersonMainBusinessLineOptions, 
                clientNonPerson, clientLegalFormOptions,familyMemberOptions, legalForm,null,null, null, isStaff ,shareProductId ,shareAccountId ,createSelfServiceUser ,tag ,localRefData);
    }
    ...
    public static ClientData lookup(final Long id, final String displayName, final Long officeId, final String officeName) {
        ...
        return new ClientData(accountNo, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id, firstname,
                ...
                savingsProductId, savingsProductName, savingsAccountId, savingAccountOptions, clientType, clientClassification,
                clientTypeOptions, clientClassificationOptions, clientNonPersonConstitutionOptions, clientNonPersonMainBusinessLineOptions, 
                clientNonPerson, clientLegalFormOptions,familyMemberOptions, legalForm,null,null, null, isStaff ,null ,null ,null ,tag ,localRefData);
    ...
    public static ClientData instance(final String accountNo, final EnumOptionData status, final CodeValueData subStatus,
            ...
            final CodeValueData clientType, final CodeValueData clientClassification, final EnumOptionData legalForm, final ClientNonPersonData clientNonPerson, final Boolean isStaff,final Long shareProductId ,final Long shareAccountId ,final Boolean createSelfServiceUser ,final String tag ,final LocalRefData localRefData) {
        ...
        return new ClientData(accountNo, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id, firstname,
                ...
                clientLegalFormOptions,familyMemberOptions, legalForm,null,null, null, isStaff,shareProductId ,shareAccountId, createSelfServiceUser ,tag ,localRefData);
    ...
    private ClientData(final String accountNo, final EnumOptionData status, final CodeValueData subStatus, final Long officeId,
            ...
            final Boolean isAddressEnabled, final List<DatatableData> datatables, final Boolean isStaff ,final Long shareProductId ,final Long shareAccountId ,final Boolean createSelfServiceUser ,final String tag ,final LocalRefData localRefData) {
