...
public class LoansApiResource {
    ...
    public LoansApiResource(final PlatformSecurityContext context, final LoanReadPlatformService loanReadPlatformService,
            ...
            final LocalRefReadPlatformService localRefReadPlatformService,
    ...
    public String template(@QueryParam("clientId") final Long clientId, @QueryParam("groupId") final Long groupId,
         ...
         appUser.validateHasReadPermission(this.resourceNameForPermissions);

         System.err.println("=================load a client template =========");
        ...
        if (templateType == null) {
            ...
            if (templateType.equals("individual") || templateType.equals("jlg")) {
                ...
                if(clientId == null) {
                    /**
                     * Modified 16/02/2023 at 0755
                     * Get office id from app user instead
                     */
                    officeId = appUser.getOffice().getId();
        ...
        System.err.println("========================set tables template");
    ...
    public String retrieveLoan(@PathParam("loanId") final Long loanId,
        ...
        final LocalRefData localRefData = localRefReadPlatformService.template(REF_TABLE.LOAN);
...
//    @Consumes({ MediaType.APPLICATION_JSON })
//    @Produces({ MediaType.APPLICATION_JSON })
//    public String retrieveAllForClient(@Context final UriInfo uriInfo,@PathParam("clientId") final Long clientId) {
//
//        this.context.authenticatedUser().validateHasReadPermission(this.resourceNameForPermissions);
//
//        final SearchParameters searchParameters = SearchParameters.forLoans(sqlSearch, externalId, offset, limit, orderBy, sortOrder,
//                accountNo);
//
//        final Page<LoanAccountData> loanBasicDetails = this.loanReadPlatformService.retrieveAllForClient(clientId);
//
//        final ApiRequestJsonSerializationSettings settings = this.apiRequestParameterHelper.process(uriInfo.getQueryParameters());
//        return this.toApiJsonSerializer.serialize(settings, loanBasicDetails, this.LOAN_DATA_PARAMETERS);
//    }
